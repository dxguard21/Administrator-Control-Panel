...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<div class='panel panel-default'><div class='panel-heading'><h3 class='panel-title'>" . $row["name"]. ": " . $row["email"]. "</h3></div><div class='panel-body'>" . $row["message"]. "</div><div class='panel-footer'>" . $row["date"]. " <a href='reply.php?id=" . $row["ID"]. "'>Reply</a></div></div>";
    }
} else {
    echo "No Messages :)";
}
